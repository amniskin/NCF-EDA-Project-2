...
write.csv(smokingBoth, "ignore/smokingBothSexes.csv", row.names = FALSE)
rm(list=c("smokingBoth", "smoking"))
```

```{r, results='hold', eval=TRUE}
smokingBoth <- read.csv("ignore/smokingBothSexes.csv", stringsAsFactors = FALSE)
```
...
rm(list= c("tmpDf", "newNames", "tmp", "aggricultureData", "aggricultureNames"))
write.csv(aggriData, "ignore/aggriculture_aggregated.csv", row.names = FALSE)
```

```{r, results='hold', eval=TRUE}
aggriData <- read.csv("ignore/aggriculture_aggregated.csv", stringsAsFactors = FALSE)
names(aggriData) <- gsub("\\.", ",", gsub("_", "\\ ", names(aggriData)))
```

```{r, results='hold', eval=TRUE}
dats <- inner_join(smokingBoth, aggriData, by=c("County", "State"))
...
printDf(complete_cases(smokingBoth), title="Complete Cases of County Smoking Data")
```
